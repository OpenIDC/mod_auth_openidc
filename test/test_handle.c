...
static char *e2e_state_cookie_value(request_rec *r, oidc_cfg_t *c, int ts_offset) {
	oidc_proto_state_t *ps = oidc_proto_state_new();
...
START_TEST(test_handle_state_cookie_name) {
	request_rec *r = oidc_test_request_get();
...
START_TEST(test_handle_state_browser_fingerprint_user_agent) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
...
START_TEST(test_handle_state_browser_fingerprint_xff) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
...
START_TEST(test_handle_state_browser_fingerprint_none) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
	cmd_parms *cmd = oidc_test_cmd_get(OIDCStateInputHeaders);
...
START_TEST(test_handle_state_cookies_clean_no_cookie_header) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
...
START_TEST(test_handle_state_cookies_clean_skip_current_and_non_state) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
	...
	char *cv = e2e_state_cookie_value(r, c, 0);
...
START_TEST(test_handle_state_cookies_clean_undecodable) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
...
START_TEST(test_handle_state_cookies_clean_valid_kept) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
...
START_TEST(test_handle_state_cookies_clean_expired_deleted) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
	...
	char *cv = e2e_state_cookie_value(r, c, -1000);
...
START_TEST(test_handle_state_cookies_clean_delete_oldest) {
	request_rec *r = oidc_test_request_get();
	oidc_cfg_t *c = oidc_test_cfg_get();
	...
	char *cv_oldest = e2e_state_cookie_value(r, c, -180);
	char *cv_mid = e2e_state_cookie_value(r, c, -120);
	char *cv_newer = e2e_state_cookie_value(r, c, -60);
	char *cv_newest = e2e_state_cookie_value(r, c, 0);
...
int main(void) {
	...
	tcase_add_test(state, test_handle_state_cookie_name);
	tcase_add_test(state, test_handle_state_browser_fingerprint_user_agent);
	tcase_add_test(state, test_handle_state_browser_fingerprint_xff);
	tcase_add_test(state, test_handle_state_browser_fingerprint_none);
	tcase_add_test(state, test_handle_state_cookies_clean_no_cookie_header);
	tcase_add_test(state, test_handle_state_cookies_clean_skip_current_and_non_state);
	tcase_add_test(state, test_handle_state_cookies_clean_undecodable);
	tcase_add_test(state, test_handle_state_cookies_clean_valid_kept);
	tcase_add_test(state, test_handle_state_cookies_clean_expired_deleted);
	tcase_add_test(state, test_handle_state_cookies_clean_delete_oldest);
