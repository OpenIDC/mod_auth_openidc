...
This module enables an Apache 2.x web server to operate as an [OpenID Connect](https://openid.net/specs/openid-connect-core-1_0.html)
...
```
Packages for other platforms are listed in the [Wiki](https://github.com/OpenIDC/mod_auth_openidc/wiki#11-where-can-i-get-binary-packages),
and release binaries are attached to the [GitHub Releases](https://github.com/OpenIDC/mod_auth_openidc/releases).

To build from source (see [`INSTALL`](INSTALL) for the full dependency list):
```sh
...
- [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html) *(Basic, Implicit, Hybrid and Refresh flows)*
...
- [OAuth 2.0 Multiple Response Type Encoding Practices 1.0](https://openid.net/specs/oauth-v2-multiple-response-types-1_0.html)
- [OpenID Connect Session Management 1.0](https://openid.net/specs/openid-connect-session-1_0.html) *see the [Wiki](https://github.com/OpenIDC/mod_auth_openidc/wiki/OpenID-Connect-Session-Management) for information on how to configure it)*
